...
const Footer1 = (props) => {
    return (
        ...
        >
            ...
            <div className="col-span-6 mb-4 sm:mb-0 sm:col-span-3 first">
                <h4 className="font-oswald text-xl lg:text-xl font-semibold mb-6 lg:mb-6 ">{config.headline1}</h4>
            ...
            <div className="col-span-6 sm:col-span-3 mb-4 sm:mb-0 first">
                ...
                <p className="text-sm font-serif">{parse(config.oeffnungszeitenText2)}</p>
            </div>
            <div className="col-span-6 sm:col-span-3 mb-6 sm:mb-0 sm:col-span-3 first">
                <h4 className="font-oswald text-xl lg:text-xl font-semibold mb-6 lg:mb-6 ">{config.headline3}</h4>
            ...
            <div className="col-span-6 mb-6 sm:mb-0 sm:col-span-3 first">
                <h4 className="font-oswald text-xl lg:text-xl font-semibold mb-6 lg:mb-6 ">{config.headline4}</h4>
